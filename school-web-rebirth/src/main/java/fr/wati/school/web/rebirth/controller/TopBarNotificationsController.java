 ...
 */
@Controller
public class TopBarNotificationsController extends DefaultPageController {

	public static final String VIEW_NAME="/topbarnotification";
	...
	public ModelAndView render() {
		...
		modelAndView.setViewName("/layouts/partials/_shared/topbar/notifications");
		super.processModelAndView(modelAndView);
		modelAndView.addObject("layout.topbar_notifications.count",3);
...
//		improvedMustacheTemplateLoader.getIncludedTemplatePath().get().put("layout.topbar", "/topBar");
